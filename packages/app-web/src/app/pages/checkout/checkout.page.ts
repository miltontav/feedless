...
export class CheckoutPage implements OnInit, OnDestroy {
  ...
  protected paymentOptions: PaymentOption[] = [
    ...
    {
      title: 'Credit Card',
      method: GqlPaymentMethod.CreditCard,
      enabled: true,
    },
  ...
  async createOrder() {
    ...
    try {
      ...
      location.href = serverConfig.apiUrl + `/checkout/${order.id}/`;
      // await this.router.navigateByUrl(`/checkout/${order.id}`);
    } catch (e) {
      this.loading = false;
      this.changeRef.detectChanges();
    }
